...
public class Main2Activity extends AppCompatActivity {
    ...
    public void init() {
        ...
        //thêm this sau khi chuyển sang sqlite
    ...
    public void checkCauTraLoi(final TextView txv) {
        ...
        //thời gian check câu trả lời (D/S)
                    ...
                    public void onFinish() {
                        if (cauTraLoi.equals(cauHoi.getDapAnDung())) {
                            ...
                            if (viTriCauHoi > 15) {
                                ...
                                txvThuaGame.setText("Chúc mừng bạn đã trở thành triệu phú với số tiền thưởng \n" + arrTienThuong.get(0) + "$ tiền sao hỏa");
                                return;
                            }
                            hienCauHoi();
                        } else {
